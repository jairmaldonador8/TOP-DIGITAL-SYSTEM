...
function calcularPosicion(paso: Paso): Posicion {
...
/**
 * Tour de bienvenida del portal: oscurece la pantalla y resalta los elementos
 * reales uno por uno. Solo se monta cuando el usuario aún no lo ha visto; al
 * terminar (o saltar) se marca en su fila de usuarios y no vuelve a salir.
 */
export function TourPortal({ action }: { action: () => Promise<void> }) {
  ...
  const [pasos, setPasos] = React.useState<Paso[] | null>(null)
